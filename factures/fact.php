...
doc.setFontStyle("bold");
        ...
        var head = [["#","pack", "nom de domaine", "date début", "date d'expiration", "espace", "prix"]];
        var body = [
        ...
        doc.autoTable({head: head, body: body, startY: 136});
